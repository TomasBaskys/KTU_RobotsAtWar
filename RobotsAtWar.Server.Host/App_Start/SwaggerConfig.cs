...
namespace RobotsAtWar.Server.Host
{
    public class SwaggerConfig
    {
        ...
        {
            return System.String.Format(@"{0}\RobotsAtWar.Server.Host.XML", System.AppDomain.CurrentDomain.BaseDirectory);
        } 
        ...
        public static void Register(HttpConfiguration httpConfig)
        {
            ...
            httpConfig
                .EnableSwagger(c =>
                {
                    ...
                    // additional fields.
                    //
                    c.SingleApiVersion("v1", "Robots At WAr")
                        .Description("Robots At War Server Service")
                        .TermsOfService("Some terms")
                        .Contact(cc => cc
                            .Name("Adform academy")
                            .Url("http://localhost:1234")
                            .Email("local@host.1234"))
                        .License(lc => lc
                            .Name("Some License")
                            .Url("http://google.com"));
